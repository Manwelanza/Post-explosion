...
{
    private static float CORRECTION_HEIGHT = 9f;
	...
	void ThirdPerson ()
	{
    	...
    	// Camera rotation
    	Quaternion camRot = Quaternion.Euler (yAngl + 20, xAngl, 0) ;
    	// Camera height
       ...
       // cam.position = new Vector3(headBone.position.x, headBone.position.y + 10, headBone.position.z - 10);
        //cam.rotation = Quaternion.Euler(yAngl, xAngl, 0);
